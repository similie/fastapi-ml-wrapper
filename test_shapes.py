...
from src.prediction_models.lstm_predictor.AllWeatherCubeRequest import makeAllWeatherQueryReq
from src.prediction_models.lstm_predictor.PredictionPostRequests import CubePredictionPostRequest
...
if __name__ == "__main__":
    ...
    assert encoder.layers[0].batch_shape[1:] == X_p.shape[1:]
    assert fc_model.inputs[0].shape[1:] == X_s_.shape[1:]
